#include <SPI.h>
#include <MFRC522.h>
#define zuid "B3 73 9C AA"         //hard coded uid for comparison
...
void loop() {
    ...
    //Save card UID for verification
    String content= "";
    ...
    //secondary data write
    byte dataBlock2[]    = {
        0x0f, 0x0e, 0x0d, 0x04, //  1,  2,   3,  4,
        0x05, 0x06, 0x07, 0x08, //  5,  6,   7,  8,
        0x09, 0x0a, 0xff, 0x0b, //  9, 10, 255, 11,
        0x0c, 0x0d, 0x0e, 0x0f  // 12, 13, 14, 15
    };
    ...
    if (count ==16 && content.substring(1) == zuid) 
    {
